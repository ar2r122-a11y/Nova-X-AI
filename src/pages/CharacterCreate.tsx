...
export default function CharacterCreate() {
    ...
    const selectedImageUri = selectedCandidateId
        ? generatedCandidates.find((c) => c.id === selectedCandidateId)?.uri || null
        : null;
                                ...
                                <div className="step-content">
                                    ...
                                    {generatedCandidates.length > 0 && (
                                        <div className="generation-info">
                                            <h4>Candidates Generated</h4>
                                            <p>{generatedCandidates.length} candidates created. Select one as your character&apos;s avatar in the preview panel.</p>
